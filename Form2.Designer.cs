...
namespace notepad
{
    partial class Form2
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label2.Text = "Простой блокнот написан на языке программирования C#, который имеет открытый исхо" +
    "дный код.\r\nПрограмма распространяется по лицензии GNU GPL 3.0 - смотрите файл LI" +
    "CENSE для подробностей\r\n";
            // 
            // button5
            // 
            ...
            this.button1.Text = "CDN | Для загрузки новой версий\r\n";
            ...
            this.label1.Text = "Codename: Chocolate BR 0.3 Build 04012023";
            // 
            // groupBox2
            // 
